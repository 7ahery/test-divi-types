...
export interface SocialMediaFollowIconAttrs {
  color?: string,
  useCustomSize?: string;
  size?: string;
}

export interface SocialMediaFollowAttrs extends InternalAttrs {
  ...
  // Design tab.
  socialIcon?: FormatAttr<SocialMediaFollowIconAttrs>;
  text?: TextGroupAttr;
